<template>
  <Transition name="fade">
    <div v-if="isVisible && product"
      class="fixed inset-0 z-50 flex justify-center items-center p-4 bg-white/30 backdrop-blur-md"
          ...
          <div class="relative flex flex-col lg:flex-row h-full">
            ...
            <div class="lg:w-1/2 p-6 bg-gray-50 flex items-center justify-center relative">
              <img :src="product.imageUrl" :alt="product.name"
                class="max-h-[60vh] w-full object-contain rounded-xl mix-blend-multiply" />
            </div>
            ...
            <div class="lg:w-1/2 p-8 overflow-y-auto">
              ...
              <div class="flex items-baseline mb-6">
                <span class="text-4xl font-extrabold"
                  :class="{ 'text-red-600': product.isPromo, 'text-gray-900': !product.isPromo }">
              ...
              <div class="space-y-4">
                ...
                <p v-if="successMessage"
                  class="text-sm font-medium text-green-700 bg-green-100 p-3 rounded-lg flex items-center">
                ...
                <button @click="addItemToCart" :disabled="isProductInCart" :class="[
                  ...
                  <svg v-if="isProductInCart" class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg v-else class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M16 11V7a4 4 0 00-4-4H7a4 4 0 00-4 4v10a4 4 0 004 4h7a4 4 0 004-4v-3m-3 2l-4-4m0 0l-4 4m4-4V3">
                    </path>
                  </svg>
                ...
                <button @click="$emit('close')"
                  class="w-full text-center text-sm text-gray-500 hover:text-green-600 transition duration-150">
...
const isProductInCart = computed(() => {
  ...
  return cartStore.items.some(i => i.id === props.product.id);
});
