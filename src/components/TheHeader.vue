    ...
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        ...
        <RouterLink to="/" class="flex items-center space-x-3 text-2xl font-extrabold text-gray-900 group">
          <!-- Icône/Logo stylisé -->
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-600 transition duration-300 group-hover:text-green-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <Transition name="slide-down">
      <div v-if="isMenuOpen" class="md:hidden bg-white/95 backdrop-blur-md shadow-xl border-t border-gray-100 pb-2">
        ...
        <RouterLink
            to="/mon-compte"
            @click="isMenuOpen = false"
            :class="mobileLinkClass('/mon-compte')"
...
.slide-down-leave-active {
  ...
  max-height: 500px; /* Grande valeur pour permettre le "slide" */
  opacity: 1;
  overflow: hidden;
}
