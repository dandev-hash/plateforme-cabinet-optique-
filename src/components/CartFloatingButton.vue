<template>
  <button 
    ...
    :class="[
      ...
      { 
        // L'animation de halo est activée quand il y a des articles
        'pulse-halo-animation shadow-green-500/70': itemCount > 0,
        'bg-gray-100/90 border-gray-400/80 text-gray-500 cursor-not-allowed': itemCount === 0 
      }
    ]"
  ...
  >
    ...
    <svg 
        :class="['h-1/3 w-1/3 transition-transform duration-300 stroke-[2.5px]', { 'animate-jiggle': itemCount > 0 }]"
...
@keyframes pulse-halo {
  0% {
    ...
    box-shadow: 0 0 0 0 rgba(16, 185, 129, 0.95); /* Green-500 très lumineux */
  }
  70% {
